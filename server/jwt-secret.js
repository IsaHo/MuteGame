 ...
 *     to mint one. 32+ hex chars = 16+ bytes of entropy; this file demands
 *     32 *characters* minimum which is the floor, not the goal.
 */
const MIN_LEN = 32;
...
function die(msg) {
  // stderr only — the user is staring at the terminal, no UI exists yet.
  console.error('');
  console.error('╔══════════════════════════════════════════════════════════════╗');
