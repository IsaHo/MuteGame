...
- شیفت صندوق با موجودی اول، تفکیک روش پرداخت، پیش‌نمایش بستن، اختلاف صندوق و تاریخچه.
- گزارش تطبیق مانده کاربران با ledger و اصلاح کنترل‌شده، idempotent و قابل audit.
